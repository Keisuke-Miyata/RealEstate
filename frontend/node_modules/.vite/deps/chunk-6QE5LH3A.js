...
function useMantineColorScheme({ keepTransitions } = {}) {
  const clearStylesRef = (0, import_react94.useRef)(noop);
  const timeoutRef = (0, import_react94.useRef)(-1);
  const ctx = (0, import_react94.useContext)(MantineContext);
  const nonce = useMantineStyleNonce();
  const nonceValue = (0, import_react94.useRef)(nonce == null ? void 0 : nonce());
  if (!ctx) {
    throw new Error("[@mantine/core] MantineProvider was not found in tree");
  }
  ...
  const toggleColorScheme = (0, import_react94.useCallback)(
...
function getWithProps(Component) {
  ...
  return (fixedProps) => {
    const Extended = (0, import_react108.forwardRef)((props, ref) => (0, import_jsx_runtime33.jsx)(_Component, { ...fixedProps, ...props, ref }));
...
function factory(ui) {
  ...
  Component.withProps = (fixedProps) => {
    const Extended = (0, import_react108.forwardRef)((props, ref) => (0, import_jsx_runtime33.jsx)(Component, { ...fixedProps, ...props, ref }));
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaCorner/ScrollAreaCorner.mjs
var Corner = (0, import_react114.forwardRef)((props, ref) => {
  const { style, ...others } = props;
  const ctx = useScrollAreaContext();
  const [width, setWidth] = (0, import_react114.useState)(0);
  const [height, setHeight] = (0, import_react114.useState)(0);
...
var ScrollAreaCorner = (0, import_react114.forwardRef)((props, ref) => {
  const ctx = useScrollAreaContext();
...
var ScrollAreaRoot = (0, import_react115.forwardRef)((_props, ref) => {
  const props = useProps("ScrollAreaRoot", defaultProps2, _props);
  const { type, scrollHideDelay, scrollbars, ...others } = props;
  const [scrollArea, setScrollArea] = (0, import_react115.useState)(null);
  const [viewport, setViewport] = (0, import_react115.useState)(null);
  const [content, setContent] = (0, import_react115.useState)(null);
  const [scrollbarX, setScrollbarX] = (0, import_react115.useState)(null);
  const [scrollbarY, setScrollbarY] = (0, import_react115.useState)(null);
  const [cornerWidth, setCornerWidth] = (0, import_react115.useState)(0);
  const [cornerHeight, setCornerHeight] = (0, import_react115.useState)(0);
  const [scrollbarXEnabled, setScrollbarXEnabled] = (0, import_react115.useState)(false);
  const [scrollbarYEnabled, setScrollbarYEnabled] = (0, import_react115.useState)(false);
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaScrollbar/Scrollbar.mjs
var Scrollbar = (0, import_react117.forwardRef)((props, forwardedRef) => {
  const {
    sizes: sizes2,
    hasThumb,
    onThumbChange,
  ...
  const [scrollbar, setScrollbar] = (0, import_react117.useState)(null);
  const composeRefs = useMergedRef(forwardedRef, (node) => setScrollbar(node));
  const rectRef = (0, import_react117.useRef)(null);
  const prevWebkitUserSelectRef = (0, import_react117.useRef)("");
  ...
  (0, import_react117.useEffect)(handleThumbPositionChange, [sizes2, handleThumbPositionChange]);
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaScrollbar/ScrollbarX.mjs
var ScrollAreaScrollbarX = (0, import_react118.forwardRef)(
  (props, forwardedRef) => {
...
var ScrollAreaScrollbarY = (0, import_react119.forwardRef)(
  (props, forwardedRef) => {
    const { sizes: sizes2, onSizesChange, style, ...others } = props;
    const context = useScrollAreaContext();
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaScrollbar/ScrollAreaScrollbarVisible.mjs
var ScrollAreaScrollbarVisible = (0, import_react120.forwardRef)((props, forwardedRef) => {
  const { orientation = "vertical", ...scrollbarProps } = props;
  const { dir } = useDirection();
  const context = useScrollAreaContext();
  const thumbRef = (0, import_react120.useRef)(null);
  const pointerOffsetRef = (0, import_react120.useRef)(0);
  const [sizes2, setSizes] = (0, import_react120.useState)({
    content: 0,
    viewport: 0,
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaScrollbar/ScrollAreaScrollbarAuto.mjs
var ScrollAreaScrollbarAuto = (0, import_react121.forwardRef)(
  (props, ref) => {
    const context = useScrollAreaContext();
...
var ScrollAreaScrollbarHover = (0, import_react122.forwardRef)(
  (props, ref) => {
    const { forceMount, ...scrollbarProps } = props;
    const context = useScrollAreaContext();
...
var ScrollAreaScrollbarScroll = (0, import_react123.forwardRef)(
  (props, red) => {
    const { forceMount, ...scrollbarProps } = props;
    const context = useScrollAreaContext();
    const isHorizontal = props.orientation === "horizontal";
    const [state, setState] = (0, import_react123.useState)("hidden");
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaScrollbar/ScrollAreaScrollbar.mjs
var ScrollAreaScrollbar = (0, import_react124.forwardRef)(
  (props, forwardedRef) => {
    const { forceMount, ...scrollbarProps } = props;
    const context = useScrollAreaContext();
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaThumb/ScrollAreaThumb.mjs
var Thumb = (0, import_react125.forwardRef)((props, forwardedRef) => {
  const { style, ...others } = props;
  const scrollAreaContext = useScrollAreaContext();
  const scrollbarContext = useScrollbarContext();
  const { onThumbPositionChange } = scrollbarContext;
  const composedRef = useMergedRef(forwardedRef, (node) => scrollbarContext.onThumbChange(node));
  const removeUnlinkedScrollListenerRef = (0, import_react125.useRef)(void 0);
...
var ScrollAreaThumb = (0, import_react125.forwardRef)(
  (props, forwardedRef) => {
...
var ScrollAreaViewport = (0, import_react126.forwardRef)(
...
var ScrollArea = factory((_props, ref) => {
  ...
  const [scrollbarHovered, setScrollbarHovered] = (0, import_react127.useState)(false);
...
var index3 = typeof document !== "undefined" ? import_react132.useLayoutEffect : import_react132.useEffect;
...
var AngleSlider = factory((_props, ref) => {
  ...
  const marksItems = marks == null ? void 0 : marks.map((mark, index5) => (0, import_react196.createElement)(
    "div",
    {
...
function OptionsDropdown({
  ...
  return (0, import_jsx_runtime152.jsx)(Combobox.Dropdown, { hidden: hidden2 || hiddenWhenEmpty && isEmpty, children: (0, import_jsx_runtime152.jsxs)(Combobox.Options, { labelledBy: labelId, "aria-label": ariaLabel, children: [
...
var Breadcrumbs = factory((_props, ref) => {
  ...
  const items = import_react248.Children.toArray(children).reduce((acc, child, index5, array) => {
    var _a;
    const item = isElement2(child) ? (0, import_react248.cloneElement)(child, {
      ...
      key: index5
    }) : (0, import_react248.createElement)("div", { ...getStyles2("breadcrumb"), key: index5 }, child);
    acc.push(item);
    if (index5 !== array.length - 1) {
      acc.push(
        (0, import_react248.createElement)(Box, { ...getStyles2("separator"), key: `separator-${index5}` }, separator)
      );
    }
    return acc;
  }, []);
...
var ColorSlider = factory((_props, ref) => {
  ...
  const layers = overlays.map((overlay, index5) => (0, import_react264.createElement)("div", { ...getStyles2("sliderOverlay"), style: overlay, key: index5 }));
...
var Swatches = (0, import_react268.forwardRef)(
  ({
    ...
    const colors = data.map((color, index5) => (0, import_react268.createElement)(
      ColorSwatch,
      {
...
var useLatest = function useLatest2(value) {
  var ref = import_react306.default.useRef(value);
  index(function() {
    ref.current = value;
  });
  return ref;
...
var useComposedRef = function useComposedRef2(libRef, userRef) {
  var prevUserRef = import_react307.default.useRef();
  return import_react307.default.useCallback(function(instance) {
...
var JsonInput = factory((props, ref) => {
  ...
  const [valid, setValid] = (0, import_react309.useState)(validateJson(_value, deserialize));
...
var MenuDropdown = factory((props, ref) => {
  ...
  const wrapperRef = (0, import_react317.useRef)(null);
  const ctx = useMenuContext();
...
var MenuItem = polymorphicFactory((props, ref) => {
  ...
  const theme = useMantineTheme();
  const { dir } = useDirection();
  const itemRef = (0, import_react318.useRef)(null);
...
var MenuTarget = (0, import_react320.forwardRef)((props, ref) => {
  ...
  return (0, import_jsx_runtime228.jsx)(Popover.Target, { refProp, popupType: "menu", ref, ...others, children: (0, import_react320.cloneElement)(children, {
    onClick,
    onMouseEnter,
    onMouseLeave,
...
function Menu(_props) {
  ...
  const [openedViaClick, setOpenedViaClick] = (0, import_react321.useState)(false);
  const close = () => {
    setOpened(false);
...
function ModalStack({ children }) {
  const [stack, setStack] = (0, import_react330.useState)([]);
  const [maxZIndex, setMaxZIndex] = (0, import_react330.useState)(getDefaultZIndex("modal"));
...
function useModalsStack(modals) {
  ...
  const [state, setState] = (0, import_react333.useState)(initialState);
  const open = (0, import_react333.useCallback)((modal) => {
    setState((current) => ({ ...current, [modal]: true }));
  }, []);
  const close = (0, import_react333.useCallback)(
    (modal) => setState((current) => ({ ...current, [modal]: false })),
    []
  );
  const toggle = (0, import_react333.useCallback)(
    (modal) => setState((current) => ({ ...current, [modal]: !current[modal] })),
    []
  );
  const closeAll = (0, import_react333.useCallback)(() => setState(initialState), []);
  const register = (0, import_react333.useCallback)(
    (modal) => ({
      opened: state[modal],
      onClose: () => close(modal),
      stackId: modal
...
var PillsInput = factory((_props, ref) => {
  ...
  const fieldRef = (0, import_react339.useRef)(null);
...
function usePersistentCallback(cb) {
  var callbackRef = (0, import_react345.useRef)(cb);
  callbackRef.current = cb;
  var persistentCbRef = (0, import_react345.useRef)(function() {
    var args = [], len = arguments.length;
    while (len--) args[len] = arguments[len];
...
function useInternalValues(value, defaultValue, valueIsNumericString, format2, removeFormatting2, onValueChange) {
  ...
  var ref = (0, import_react345.useState)(function() {
  ...
  (0, import_react345.useMemo)(function() {
    setValues(newValues);
...
function NumberFormatBase(props) {
  ...
  var caretPositionBeforeChange = (0, import_react345.useRef)();
  var lastUpdatedValue = (0, import_react345.useRef)({ formattedValue, numAsString });
  ...
  var ref$1 = (0, import_react345.useState)(false);
  var mounted = ref$1[0];
  var setMounted = ref$1[1];
  var focusedElm = (0, import_react345.useRef)(null);
  var timeout = (0, import_react345.useRef)({
    setCaretTimeout: null,
    focusTimeout: null
  });
  (0, import_react345.useEffect)(function() {
    setMounted(true);
    return function() {
  ...
  var useIsomorphicLayoutEffect2 = typeof window !== "undefined" ? import_react345.useLayoutEffect : import_react345.useEffect;
  ...
  if (displayType === "text") {
    return renderText ? import_react345.default.createElement(import_react345.default.Fragment, null, renderText(formattedValue, otherProps) || null) : import_react345.default.createElement("span", Object.assign({}, otherProps, { ref: getInputRef }), formattedValue);
  } else if (customInput) {
    var CustomInput = customInput;
    return import_react345.default.createElement(CustomInput, Object.assign({}, inputProps, { ref: getInputRef }));
  }
  return import_react345.default.createElement("input", Object.assign({}, inputProps, { ref: getInputRef }));
}
...
function NumericFormat(props) {
  ...
  return import_react345.default.createElement(NumberFormatBase, Object.assign({}, numericFormatProps));
}
...
var NumberInput = factory((_props, ref) => {
  ...
  const inputRef = (0, import_react347.useRef)(null);
  const onStepTimeoutRef = (0, import_react347.useRef)(null);
  const stepCountRef = (0, import_react347.useRef)(0);
  ...
  const incrementRef = (0, import_react347.useRef)(noop);
  ...
  const decrementRef = (0, import_react347.useRef)(noop);
...
function createEdgeComponent({ icon, name, action, type }) {
  ...
  const Component = (0, import_react351.forwardRef)((props, ref) => {
...
var PinInput = factory((props, ref) => {
  ...
  const [focusedIndex, setFocusedIndex] = (0, import_react355.useState)(-1);
  ...
  const inputsRef = (0, import_react355.useRef)([]);
  const validate = (code) => {
  ...
  return (0, import_jsx_runtime265.jsxs)(import_jsx_runtime265.Fragment, { children: [
    (0, import_jsx_runtime265.jsx)(
      Group,
      {
        ...
        __size: size3,
        dir: "ltr",
        children: _value.map((char, index5) => (0, import_react355.createElement)(
          Input,
          {
            component: "input",
            ...getStyles2("pinInput", {
...
var Rating = factory((_props, ref) => {
  ...
  const _name = useId(name);
  const _id = useId(id);
  const rootRef = (0, import_react370.useRef)(null);
  const [_value, setValue] = useUncontrolled({
    value,
    defaultValue,
    finalValue: 0,
  ...
  const [hovered, setHovered] = (0, import_react370.useState)(-1);
  const [isOutside, setOutside] = (0, import_react370.useState)(true);
...
function useFloatingTooltip({
  ...
  const [opened, setOpened] = (0, import_react371.useState)(defaultOpened);
  const boundaryRef = (0, import_react371.useRef)(null);
  ...
  const handleMouseMove = (0, import_react371.useCallback)(
    ({ clientX, clientY }) => {
...
var TooltipFloating = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime283.jsxs)(import_jsx_runtime283.Fragment, { children: [
    ...
    (0, import_react373.cloneElement)(children, {
      ..._childrenProps,
      [refProp]: targetRef,
      onMouseEnter,
      onMouseLeave
...
var TooltipGroupContext = (0, import_react374.createContext)(false);
var TooltipGroupProvider = TooltipGroupContext.Provider;
var useTooltipGroupContext = () => (0, import_react374.useContext)(TooltipGroupContext);
...
function useTooltip(settings) {
  var _a, _b, _c;
  const [uncontrolledOpened, setUncontrolledOpened] = (0, import_react377.useState)(settings.defaultOpened);
  const controlled = typeof settings.opened === "boolean";
  const opened = controlled ? settings.opened : uncontrolledOpened;
  const withinGroup = useTooltipGroupContext();
  const uid = useId();
  const onChange = (0, import_react377.useCallback)(
    (_opened) => {
...
var Tooltip = factory((_props, ref) => {
  ...
  const { dir } = useDirection();
  const arrowRef = (0, import_react379.useRef)(null);
  ...
  return (0, import_jsx_runtime285.jsxs)(import_jsx_runtime285.Fragment, { children: [
    ...
    (0, import_react379.cloneElement)(
      children,
...
var RingProgress = factory((_props, ref) => {
  ...
  const curves = getCurves({
    ...
    rootColor
  }).map(({ data, sum, root, lineRoundCaps, offset: offset3 }, index5) => (0, import_react382.createElement)(
    Curve,
    {
      ...data,
      key: index5,
...
var SegmentedControl = factory((_props, ref) => {
  ...
  const [parent, setParent] = (0, import_react383.useState)(null);
  const [refs, setRefs] = (0, import_react383.useState)({});
  ...
  const controls = _data.map((item) => (0, import_react383.createElement)(
    Box,
    {
      ...getStyles2("control"),
    ...
    (0, import_react383.createElement)(
      "input",
      {
        ...getStyles2("input"),
...
var Select = factory((_props, ref) => {
  ...
  const parsedData = (0, import_react384.useMemo)(() => getParsedComboboxData(data), [data]);
  const optionsLockup = (0, import_react384.useMemo)(() => getOptionsLockup(parsedData), [parsedData]);
  const _id = useId(id);
  const [_value, setValue, controlled] = useUncontrolled({
    value,
    defaultValue,
...
var SliderRoot = (0, import_react390.forwardRef)(
...
var Thumb3 = (0, import_react391.forwardRef)(
  ({
    max: max2,
    min: min2,
    value,
    ...
    const { getStyles: getStyles2 } = useSliderContext();
    const [focused, setFocused] = (0, import_react391.useState)(false);
...
function Marks({ marks, min: min2, max: max2, disabled, value, offset: offset3, inverted }) {
  ...
  const items = marks.map((mark, index5) => (0, import_react392.createElement)(
    Box,
    {
...
var Slider = factory((_props, ref) => {
  ...
  const root = (0, import_react394.useRef)(null);
  const thumb = (0, import_react394.useRef)(null);
  const position = getPosition({ value: _value, min: min2, max: max2 });
  const scaledValue = scale(_value);
  const _label = typeof label === "function" ? label(scaledValue) : label;
  const precision = _precision ?? getPrecision(step);
  const handleChange = (0, import_react394.useCallback)(
    ({ x }) => {
      if (!disabled) {
...
var RangeSlider = factory((_props, ref) => {
  ...
  const { dir } = useDirection();
  const [focused, setFocused] = (0, import_react395.useState)(-1);
  ...
  const thumbs = (0, import_react395.useRef)([]);
  const thumbIndex = (0, import_react395.useRef)(void 0);
  const positions = [
...
var Stepper = factory((_props, ref) => {
  ...
  const convertedChildren = import_react401.Children.toArray(children);
  ...
  const items = _children.reduce(
    (acc, item, index5) => {
      ...
      acc.push(
        (0, import_react401.cloneElement)(item, {
      ...
      if (orientation === "horizontal" && index5 !== _children.length - 1) {
        acc.push(
          (0, import_react401.createElement)(
            "div",
            {
...
var SwitchGroupContext = (0, import_react402.createContext)(null);
var SwitchGroupProvider = SwitchGroupContext.Provider;
var useSwitchGroupContext = () => (0, import_react402.useContext)(SwitchGroupContext);
...
var TagsInput = factory((_props, ref) => {
  ...
  const parsedData = getParsedComboboxData(data);
  const optionsLockup = getOptionsLockup(parsedData);
  const inputRef = (0, import_react416.useRef)(null);
...
var Timeline = factory((_props, ref) => {
  ...
  const _children = import_react421.Children.toArray(children);
  const items = _children.map(
    (item, index5) => {
      var _a, _b;
      return (0, import_react421.cloneElement)(item, {
        unstyled,
        __align: align,
...
function TreeNode({
  ...
  const ref = (0, import_react424.useRef)(null);
...
function useTree({
  ...
  const [data, setData] = (0, import_react427.useState)([]);
  const [expandedState, setExpandedState] = (0, import_react427.useState)(initialExpandedState);
  const [selectedState, setSelectedState] = (0, import_react427.useState)(initialSelectedState);
  const [checkedState, setCheckedState] = (0, import_react427.useState)(initialCheckedState);
  const [anchorNode, setAnchorNode] = (0, import_react427.useState)(null);
  const [hoveredNode, setHoveredNode] = (0, import_react427.useState)(null);
  const initialize = (0, import_react427.useCallback)(
    (_data) => {
  ...
  const toggleExpanded = (0, import_react427.useCallback)(
    (value) => {
  ...
  const collapse = (0, import_react427.useCallback)(
    (value) => {
      setExpandedState((current) => {
  ...
  const expand = (0, import_react427.useCallback)(
    (value) => {
      setExpandedState((current) => {
  ...
  const expandAllNodes = (0, import_react427.useCallback)(() => {
    setExpandedState((current) => {
      const next = { ...current };
  ...
  const collapseAllNodes = (0, import_react427.useCallback)(() => {
    setExpandedState((current) => {
      const next = { ...current };
      Object.keys(next).forEach((key) => {
        next[key] = false;
  ...
  const toggleSelected = (0, import_react427.useCallback)(
  ...
  const select = (0, import_react427.useCallback)((value) => {
    setAnchorNode(value);
    setSelectedState(
      (current) => multiple ? current.includes(value) ? current : [...current, value] : [value]
    );
  }, []);
  const deselect = (0, import_react427.useCallback)((value) => {
    anchorNode === value && setAnchorNode(null);
    setSelectedState((current) => current.filter((item) => item !== value));
  }, []);
  const clearSelected = (0, import_react427.useCallback)(() => {
    setSelectedState([]);
    setAnchorNode(null);
  }, []);
  const checkNode = (0, import_react427.useCallback)(
    (value) => {
  ...
  const uncheckNode = (0, import_react427.useCallback)(
    (value) => {
      const checkedNodes = getChildrenNodesValues(value, data);
  ...
  const checkAllNodes = (0, import_react427.useCallback)(() => {
    setCheckedState(() => getAllChildrenNodes(data));
  }, [data]);
  const uncheckAllNodes = (0, import_react427.useCallback)(() => {
    setCheckedState([]);
  }, []);
...
var Tree = factory((_props, ref) => {
  ...
  const flatValues = (0, import_react428.useMemo)(() => getFlatValues(data), [data]);
  (0, import_react428.useEffect)(() => {
...
tabbable/dist/index.esm.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-6QE5LH3A.js.map

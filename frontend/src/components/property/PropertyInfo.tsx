...
const PropertyInfo: FC<FeatureDetailProps> = ({ post }) => {
    const dateOnly: string = new Date(post.dateAvailability).toISOString().split('T')[0];
    ...
    return (
        ...
        <div className="bg-white shadow-xl rounded-lg mt-20 p-8 mx-auto max-w-4xl">
            ...
            <div className="flex items-center justify-between bg-orange-100 p-6 rounded-lg shadow-md mb-8">
                ...
                <ul className="flex gap-6 pl-5 flex-wrap">
